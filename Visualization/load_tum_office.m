function [rgb1,rgb2,depth1,depth2,R12,T12]=load_tum_office(im1_id,im2_id)
% Set the camera parameters % could be changed
sequence_path = '/home/chchien/datasets/TUM-RGBD/rgbd_dataset_freiburg3_long_office_household/';
% sequence_path = './rgbd_dataset_freiburg3_long_office_household/';
camera_params.fx = 525.0;
camera_params.fy = 525.0;
camera_params.cx = 319.5;
camera_params.cy = 239.5;
camera_params.depth_scale = 5000.0;
