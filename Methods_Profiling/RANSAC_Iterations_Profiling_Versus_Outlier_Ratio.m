...
PARAMS.TARGET_OUTLIER_RATIO       = 7; %> 5: 40%~49%
...
PARAMS.ORIENTATION_DEG_TOL              = 1;
PARAMS.TRANSLATION_DIST_TOL             = 0.05;

%> Load all outlier ratio data
all_Outlier_Ratios_Dir = "/home/chchien/BrownU/research/RGBD_1-Point_RANSAC/Sourav_Code/Methods_Profiling/Outlier_Ratios/";
